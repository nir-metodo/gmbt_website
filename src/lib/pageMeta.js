...
export const PAGE_META = {
  ...
  aiLeadBot: {
    title: 'בוט לידים וואטסאפ | AI Lead Bot לעסקים | גמבוט ישראל 2026',
    description: 'בוט לידים AI לוואטסאפ - הסמכת לידים אוטומטית, ניהול פייפליין ועדכון CRM. הגדילו את אחוז הסגירה ב-300%.',
    keywords: 'בוט לידים וואטסאפ, AI lead bot, ניהול לידים, WhatsApp CRM, סוכן מכירות AI',
    canonical: 'https://gambot.co.il/בוט-לידים-וואטסאפ',
    hreflang: { he: 'https://gambot.co.il/בוט-לידים-וואטסאפ', en: 'https://gambot.co.il/en/ai-lead-bot' },
  },
  whatsappAppointment: {
  ...
  mediaManagement: {
    ...
    hreflang: { he: 'https://gambot.co.il/ניהול-מדיה', en: 'https://gambot.co.il/whatsapp-marketing-reports' },
  },
  marketingSystem: {
    ...
    hreflang: { he: 'https://gambot.co.il/מערכת-שיווק-בוואטסאפ', en: 'https://gambot.co.il/whatsapp-messaging-system' },
  },
  pricing: {
