...
export default function PricingContent() {
  ...
  const FAQ = [
    ...
    { q: 'מה לא כלול בתמיכה?', a: 'בניית בוטים ואוטומציות, הקמת קמפיינים, הדרכות עובדים, ייעוץ עסקי וחיבור מערכות חיצוניות — כל אלה מתומחרים בנפרד החל מ-₪555/שעה + מע״מ.' },
    { q: 'כמה עולים שירותי פיתוח והדרכה?', a: 'פיתוח והתאמות: ₪555/שעה + מע״מ. הדרכת עובדים: החל מ-₪600. בניית בוטים ואוטומציות: לפי היקף הפרויקט.' },
  ];
        ...
        <div className={styles.container}>
          ...
          <div className={styles.supportGrid}>
            ...
            <div className={styles.supportBox}>
              ...
              <ul className={styles.supportList}>
                <li>פיתוח והתאמות — <strong>₪555/שעה + מע״מ</strong></li>
