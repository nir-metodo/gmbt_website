...
const plans = [
  {
    ...
    features: [
      ...
      "120 תגובות / פעולות AI (כל 500 נוספות 50 ₪)",
      "⚡ 25 הודעות Pro Active כלולות (כל 25 נוספות 15 ₪)",
      "3 משתמשים (כל משתמש נוסף 30 ₪)",
      "תמיכה בסיסית",
    ],
    moreFeatures: [
  ...
  },
  {
    ...
    features: [
      ...
      "1250 תגובות / פעולות AI (כל 500 נוספות 50 ₪)",
      "⚡ 150 הודעות Pro Active כלולות (כל 25 נוספות 15 ₪)",
      "8 משתמשים (כל משתמש נוסף 30 ₪)",
      "תמיכה עדיפה",
    ],
    moreFeatures: [
      "ניהול לידים ו-CRM מלא",
