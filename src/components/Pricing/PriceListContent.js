...
const plans = [
  ...
  },
  {
    ...
    moreFeatures: [
      ...
      "עד 1,000 פניות בחודש",
      "עד 300 הצעות מחיר בחודש",
      "עד 400 הזמנות בחודש (Shopify / WooCommerce)",
      "עד 300 חתימות דיגיטליות בחודש",
      "📄 חשבוניות — תוספת ₪89/חודש (עד 300 חשבוניות)",
      "ניהול משימות מתקדם",
      "דוחות וניתוח נתונים",
  ...
  },
  {
    ...
    moreFeatures: [
      "עד 4,000 לידים בחודש",
      "עד 4,000 פניות בחודש",
      "עד 1,000 הצעות מחיר בחודש",
      "עד 1,200 הזמנות בחודש (Shopify / WooCommerce)",
      "עד 1,000 חתימות דיגיטליות בחודש",
      "📄 עד 1,000 חשבוניות בחודש (כלול)",
      "ניהול משימות מתקדם",
