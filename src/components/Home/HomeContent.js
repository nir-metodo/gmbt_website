...
const DATA = {
  he: {
    ...
    heroTitle: ['Gambot — מערכת ', 'WhatsApp API', ' מובילה בישראל'],
    heroDesc: 'גמבוט (Gambot) — שותף מטא רשמי. בוט AI, אוטומציה, קמפיינים ושירות לקוחות 24/7 — הכל ללא קוד, עם ממשק עברי מלא ותמיכה ישראלית',
    ...
    ourFeatures: [
      ...
      { icon: '📞', title: 'טלפוניה', desc: 'שיחות טלפון נכנסות ויוצאות מהדפדפן או מהנייד, הקלטת שיחות, סיכום AI ושיוך אוטומטי לאיש קשר.', isNew: true },
      { icon: '🧾', title: 'חשבוניות', desc: 'הפקת חשבוניות, קבלות וחשבוניות מס ישירות מהמערכת — חיבור לרשויות המס ושליחה אוטומטית ללקוח.', isNew: true },
    ],
  ...
  en: {
    ...
    heroTitle: ['Gambot — Leading ', 'WhatsApp API', ' Platform in Israel'],
    heroDesc: 'Gambot is Israel\'s #1 WhatsApp Business API platform. AI Bot, Automation, Campaigns & 24/7 Customer Service — all without code. Official Meta Partner.',
    ...
    ourFeatures: [
      ...
      { icon: '📞', title: 'Telephony', desc: 'Inbound and outbound phone calls from browser or mobile, call recording, AI summary and automatic contact association.', isNew: true },
      { icon: '🧾', title: 'Invoices', desc: 'Generate invoices, receipts and tax invoices directly from the system — connected to tax authorities with automatic delivery to customers.', isNew: true },
    ],
  ...
  '@graph': [
    {
      ...
      logo: { '@type': 'ImageObject', url: 'https://gambot.co.il/apple-touch-icon.png', width: 180, height: 180 },
      sameAs: ['https://www.facebook.com/gambotwhatsapp', 'https://www.linkedin.com/company/gambot-platform'],
      contactPoint: { '@type': 'ContactPoint', telephone: '+97233768997', contactType: 'sales', availableLanguage: ['Hebrew', 'English'] },
      address: { '@type': 'PostalAddress', addressCountry: 'IL', addressLocality: 'Tel Aviv' },
      description: 'Gambot is Israel\'s leading WhatsApp Business API platform. Official Meta Business Solution Provider.',
      foundingDate: '2020',
    ...
    },
    {
      ...
      name: 'Gambot',
      alternateName: 'גמבוט',
      description: 'Gambot — WhatsApp Business API Platform for businesses in Israel',
      inLanguage: ['he', 'en'],
    ...
    },
    {
      ...
      aggregateRating: { '@type': 'AggregateRating', ratingValue: '4.9', ratingCount: '520', bestRating: '5' },
      description: 'Gambot — WhatsApp Business API platform with AI chatbot, automation, campaigns, CRM and customer service.',
      featureList: 'WhatsApp AI Bot, Automation, Campaigns, CRM, Lead Management, Appointment Scheduling, Digital Invoices',
    },
  ],
};
