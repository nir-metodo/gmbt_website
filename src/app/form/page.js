...
const DocumentFormPublic = dynamic(
  () => import('@/components/DocumentTemplates/DocumentFormPublic'),
  {
    ssr: false,
    loading: () => (
      <div style={{
        ...
        <p style={{ color: '#666', fontSize: '16px' }}>Loading form...</p>
      </div>
    )
  }
);
